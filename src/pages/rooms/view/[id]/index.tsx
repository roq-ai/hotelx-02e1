              ...
              {hasAccess('reservation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/reservations/create?room_id=${data?.id}`}>
                      ...
                      <Tbody>
                        {data?.reservation?.map((record) => (
                          <Tr
                            ...
                            key={record.id}
                          >
                            <Td>{record.check_in_date as unknown as string}</Td>
                            <Td>{record.check_out_date as unknown as string}</Td>
                            <Td>
